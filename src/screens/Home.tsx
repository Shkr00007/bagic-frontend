    ...
    <div className="min-h-screen bg-[#F8FAFC] pb-24 md:pb-8">
      ...
      <main className="max-w-[960px] mx-auto px-6 md:px-12 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          <div
            onClick={() => {
              if (
                ...
                lastSession &&
                lastSession.sessionStatus !== 'COMPLETED'
              ) {
                onStartSession?.(lastSession.sessionId);
              }
            }}
            className="bg-white rounded-lg shadow-sm border border-[#E2E8F0] p-6 hover:border-[#1E40AF] transition-colors cursor-pointer"
          >
            ...
            activeSession.sessionStatus !== 'COMPLETED' ? (
              <>
                ...
                <div className="space-y-2 mb-4">
                  <p className="text-meta text-[#64748B]">
                    {getTimeSince(activeSession.started_at)} -{' '}
                    {activeSession.framework_type}
                  </p>

                  <BoundaryChip
                    text={`Framework: ${activeSession.framework_type} ✓`}
                  />
                ...
                <p className="text-body text-[#1E293B]">
                  Current stage: {activeSession.current_stage} -{' '}
              ...
              <>
                ...
                <div className="space-y-2 mb-4">
                  <p className="text-meta text-[#64748B]">
                    {getTimeSince(lastSession.started_at)} -{' '}
                    {lastSession.framework_type}
                  </p>

                  <BoundaryChip
                    text={`Framework: ${lastSession.framework_type} ✓`}
                  />
                </div>
          ...
          {/* Experiments (Synthetic Placeholder) */}
          <div className="bg-white rounded-lg shadow-sm border border-[#E2E8F0] p-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-h2">My Experiments</h2>
              <Beaker className="w-5 h-5 text-[#F59E0B]" />
            ...
            <p className="text-body text-[#64748B]">
              Experiments are generated during coaching sessions.
            </p>

            <div className="mt-3 text-meta text-[#64748B] flex items-center gap-2">
              <Clock className="w-3 h-3" />
              Synthetic local mode enabled
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          <p className="text-meta text-[#64748B]">
            Framework-governed coaching - Local synthetic mode
          </p>
        </div>
      </main>
