    ...
    ? [
        {
          ...
          value: `${metrics.framework_compliance_rate}%`,
          status:
            metrics.framework_compliance_rate >= 95
              ? 'success'
              : 'warning',
          sqlRef: 'SQL-001',
          trend: 'stable',
        },
        {
          ...
          value: String(metrics.ethical_violations_count),
          status:
            metrics.ethical_violations_count === 0
              ? 'success'
              : 'critical',
          sqlRef: 'SQL-002',
          trend: 'stable',
        },
        {
          ...
          value: `${metrics.explainability_rate}%`,
          status:
            metrics.explainability_rate >= 95
              ? 'success'
              : 'warning',
          sqlRef: 'SQL-003',
          trend: 'stable',
        },
        {
          ...
          value: String(metrics.active_escalations_count),
          status:
            metrics.active_escalations_count === 0
              ? 'success'
              : 'warning',
          sqlRef: 'BT-004',
          trend: 'stable',
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          {loading ? (
            ...
            <>
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <h3 className="text-h1 mb-2 flex items-center gap-2">
                          ...
                          <span
                            className={`text-h2 ${getStatusColor(
                              kpi.status
                            )}`}
                          >
                            {getStatusIcon(kpi.status)}
              ...
              <div className="mt-8 text-center">
                <p className="text-meta text-[#64748B]">
                  Synthetic governance mode - Local only - Demo ready
                </p>
              </div>
            </>
          )}
