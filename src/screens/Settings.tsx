...
export function Settings({ onNavigate }: SettingsProps) {
  ...
  useEffect(() => {
    const stored = sessionStorage.getItem('employeePreferences');
    if (stored) {
    ...
    <div className="min-h-screen bg-[#F8FAFC] pb-24 md:pb-8">
      ...
      <main className="max-w-[960px] mx-auto px-6 md:px-12 py-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-[#E2E8F0] p-6">
            ...
            <div className="space-y-4 text-body text-[#64748B]">
              <div>
                ...
                <p>
                  In synthetic mode, conversations are stored locally in your browser only.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  Escalations are simulated in demo mode. No real HR notifications occur.
                </p>
              </div>
              ...
              <div className="pt-4 border-t border-[#E2E8F0]">
                <label className="flex items-center justify-between cursor-pointer">
                  <span className="text-[#1E293B]">
                    Email reminders for experiments
                  </span>
                  <input
                    type="checkbox"
                    checked={preferences.email_reminders}
          ...
          <div className="bg-white rounded-lg shadow-sm border border-[#E2E8F0] p-6">
            ...
            <div className="space-y-4">
              <label className="flex items-center justify-between cursor-pointer">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setPreferences({
                      ...preferences,
                      show_framework_stages: e.target.checked,
                    })
                  }
                  className="w-5 h-5 text-[#1E40AF] border-[#E2E8F0] rounded focus:ring-2 focus:ring-[#1E40AF]"
                />
              ...
              <label className="flex items-center justify-between cursor-pointer">
                <span className="text-body text-[#1E293B]">
                  Enable CBC cognitive pattern detection
                </span>
                <input
                  type="checkbox"
                  checked={preferences.enable_cbc_detection}
                  onChange={(e) =>
                    setPreferences({
                      ...preferences,
                      enable_cbc_detection: e.target.checked,
                    })
                  }
                  className="w-5 h-5 text-[#1E40AF] border-[#E2E8F0] rounded focus:ring-2 focus:ring-[#1E40AF]"
                />
        ...
        <div className="mt-6 bg-white rounded-lg shadow-sm border border-[#E2E8F0] p-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <p className="text-body text-[#1E293B] font-medium mb-1">
                Profile
              </p>
              <p className="text-meta text-[#64748B]">
                {profile?.full_name} - {profile?.employee_id}
